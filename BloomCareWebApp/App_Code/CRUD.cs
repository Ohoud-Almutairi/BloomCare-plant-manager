...
/// </summary>
/// 
namespace Ohoud10108WebApp.App_Code
{
   public  class CRUD
    {
        ...
        public static string conStr = WebConfigurationManager.ConnectionStrings["Ohoud10108ConStr"].ConnectionString;
        // I create a con object once and then use it in methods
        public SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["Ohoud10108ConStr"].ConnectionString);
        public CRUD()
        {
            //
        ...
        public DataTable RetrieveTable(string query)
        {
